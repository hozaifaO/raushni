...
class CampaignModel(Base):
    ...
    amount_raised: Mapped[Decimal] = mapped_column(Numeric(14, 2), nullable=False, default=0)
    ...
    owner: Mapped[str] = mapped_column(String(120), nullable=False, default="Fundraising Team")
    highlights: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list)
    impact_metrics: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list)
...
class CampaignDonationModel(Base):
    ...
    payment_method: Mapped[str] = mapped_column(String(80), nullable=False, default="upi")
