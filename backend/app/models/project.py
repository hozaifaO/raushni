...
class ProjectModel(Base):
    ...
    focus_area: Mapped[str] = mapped_column(String(120), nullable=False, default="Education and WATSAN")
    ...
    manager: Mapped[str] = mapped_column(String(120), nullable=False, default="Project Manager")
