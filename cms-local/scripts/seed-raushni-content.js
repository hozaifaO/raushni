...
const landingPageContent = {
  ...
  focusAreas: [
    {
      title: "Education",
      text: "Bridge learning gaps through mentoring, digital literacy, school readiness, books, and structured academic support.",
    },
    {
      title: "Healthcare",
      text: "Improve access to basic care, health camps, nutrition awareness, referrals, and preventive community health practices.",
    },
    {
      title: "Livelihood",
      text: "Support self-help groups, vocational skills, savings habits, micro-enterprise readiness, and dignified income pathways.",
    },
    {
      title: "Environment",
      text: "Promote tree plantation, cleanliness drives, waste awareness, and local responsibility for safer public spaces.",
    },
  ],
  objectives: [
