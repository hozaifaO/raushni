  ...
  return (
    <article className="mx-auto max-w-4xl border-[10px] border-gray-900 bg-white p-10 text-center text-gray-950 shadow-sm">
      ...
      <div className="mt-10 grid grid-cols-[1fr_120px_1fr] items-end gap-6 text-sm text-gray-600">
        ...
        <div className="grid h-28 w-28 place-items-center justify-self-center rounded-lg border border-gray-200 p-2" dangerouslySetInnerHTML={qrCodeSvg ? { __html: qrCodeSvg } : undefined}>
          {!qrCodeSvg && <span className="text-xs font-bold">QR</span>}
        </div>
