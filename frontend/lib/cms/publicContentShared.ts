/**
 * Client-safe CMS types and static fallbacks.
 * Do not import server-only modules (next/headers, cms/client) here.
 */
...
export function resolveMediaUrl(media: unknown, fallback: string) {
